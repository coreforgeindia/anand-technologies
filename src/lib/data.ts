// Base URL for R2-hosted datasheets. Set NEXT_PUBLIC_R2_BASE_URL in .env.local
// after enabling public access on the "anand-technologies-datasheets" R2 bucket.
...
// Auto-generate datasheet URL from product name — matches R2 filenames exactly
export function datasheetUrlFromName(productName: string): string | null {
  return datasheetUrl(`${productName}.pdf`)
}
...
export const sampleProducts = [
  ...
  // ── GSM / LTE ANTENNAS ──────────────────────────────────────────────────────
  {
    ...
    get datasheet_url() { return datasheetUrl('AT-ANT-QGSM-SMA210-3.5(SL).pdf') },
  ...
  },
  {
    ...
    get datasheet_url() { return datasheetUrl('AT-ANT-QGSM-SMA110-3.0 (SL).pdf') },
  ...
  },
  {
    ...
    get datasheet_url() { return datasheetUrl('AT-ANT-QGSM-SMA305-5.0 (SL).pdf') },
  ...
  },
  {
    ...
    get datasheet_url() { return datasheetUrlFromName(this.name) }, image_url: null as string | null, created_at: '2024-01-01',
  },
  {
