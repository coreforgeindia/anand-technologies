...
const productMeta: Record<string, { product_name: string; pdf: string | null }> = {
  ...
  'cpl-002': { product_name: 'Hybrid Coupler', pdf: 'AT-COUPLER-117.pdf' },
  // Band Pass Filters
  'bpf-001': { product_name: 'Band Pass Filter 900 MHz', pdf: 'Band Pass Filter.pdf' },
...
export const sampleProducts = [
  ...
  {
    id: 'gsm-010', name: 'AT-ANT-LTE-ENH-SMA260-3.5(CDOT)', slug: 'at-ant-lte-enh-sma260-35-cdot',
    category: 'gsm-lte-antennas', short_spec: 'LTE Enhanced Sleeve Antenna, SMA, 260mm',
    frequency_range: '700–2700 MHz',
    description: 'LTE enhanced sleeve antenna with SMA male connector and 260mm cable for wideband 4G LTE operation.',
    specs: { 'Frequency': '700–2700 MHz', 'Gain': '3.5 dBi', 'Type': 'Sleeve', 'Connector': 'SMA Male', 'Cable': 'RG174, 260mm', 'Impedance': '50 Ω', 'VSWR': '< 2.0:1' },
  ...
  {
    id: 'gps-003', name: 'AT-ANT-GPSE-SMAM-MM174-30-5', slug: 'at-ant-gpse-smam-mm174-30-5',
    category: 'gps-gnss-antennas', short_spec: 'GPS External Active Antenna, SMA, 27.5 dB LNA, 5m RG174',
  ...
  {
    id: 'gps-008', name: 'AT-ANT-IRNSS-5', slug: 'at-ant-irnss-5',
  ...
  // ── WiFi ANTENNAS ───────────────────────────────────────────────────────────
  {
    id: 'wifi-001', name: 'AT-ANT-WIFI-DB-RPSMA305-5.0', slug: 'at-ant-wifi-db-rpsma305-50',
    category: 'wifi-antennas', short_spec: 'Dual-band WiFi Antenna, RP-SMA, 5 dBi, 305mm',
  ...
  // ── VHF / UHF ANTENNAS ──────────────────────────────────────────────────────
  {
    ...
    category: 'vhf-uhf-antennas', short_spec: 'UHF Omni Antenna, SMA, 2.15 dBi',
  ...
  },
  {
    ...
    category: 'vhf-uhf-antennas', short_spec: 'UHF Omni Antenna, SMA, 1.5 dBi',
    frequency_range: '136–174 MHz',
  ...
  // ── DUPLEXERS ───────────────────────────────────────────────────────────────
  {
    ...
    specs: { 'TX Band': '136–148 MHz', 'RX Band': '148–174 MHz', 'Insertion Loss TX': '< 1.5 dB', 'Insertion Loss RX': '< 1.5 dB', 'TX-RX Isolation': '> 70 dB', 'VSWR': '< 1.3:1', 'Power': '100W avg', 'Connector': 'N Female', 'Temperature': '-30°C to +70°C' },
  ...
  },
  {
    ...
    frequency_range: 'TX 703–733 MHz / RX 758–788 MHz',
  ...
  },
  {
    ...
    category: 'duplexers', short_spec: 'LTE Band 28 Cavity Duplexer, 758–803 MHz',
    frequency_range: 'TX 791–821 MHz / RX 832–862 MHz',
    ...
    specs: { 'TX Band': '791–821 MHz', 'RX Band': '832–862 MHz', 'Insertion Loss': '< 1.0 dB', 'TX-RX Isolation': '> 80 dB', 'PIM': '< -153 dBc @ 2 × 43dBm', 'Power': '100W avg', 'Connector': 'N Female' },
  ...
  },
  {
    ...
    category: 'duplexers', short_spec: 'DCS / LTE Band 3 Cavity Duplexer, 1710–1785 MHz',
    frequency_range: 'TX 1710–1785 MHz / RX 1805–1880 MHz',
  ...
  // ── DIPLEXERS ───────────────────────────────────────────────────────────────
  {
    ...
    frequency_range: 'TX1 4397.5–4522.5 MHz / TX2 4877.5–5002.5 MHz / RX 4637.5–4762.5 MHz',
    ...
    specs: { 'TX1 Band': '4397.5–4522.5 MHz', 'TX2 Band': '4877.5–5002.5 MHz', 'RX Band': '4637.5–4762.5 MHz', 'Insertion Loss TX': '< 1.5 dB', 'Insertion Loss RX': '< 1.5 dB', 'TX-RX Isolation': '> 90 dB', 'VSWR': '< 1.3:1', 'Power': '100W avg', 'Connector': 'N Female, SMA Female', 'Temperature': '-30°C to +70°C' },
  ...
  {
    id: 'spl-005', name: 'AT-GPS-SPLITTER-2', slug: 'at-gps-splitter-2',
  ...
  // ── ATTENUATORS ─────────────────────────────────────────────────────────────
  {
    id: 'att-001', name: 'AttenuatorFX-H2', slug: 'attenuator-fx-h2',
  ...
  },
  {
    ...
    category: 'couplers', short_spec: 'Hybrid Coupler, 900–960 MHz, N Female',
    frequency_range: '900–960 MHz',
    description: 'Hybrid coupler with N Female connectors, 4 ports, and better than 20 dB isolation for 900–960 MHz operation.',
    specs: { 'Frequency': '900–960 MHz', 'Type': 'N (F), Band Pass', 'Isolation': '> 20 dB', 'Connector': 'N Female', 'Ports': '4', 'VSWR': '< 1.5:1' },
  ...
  // ── BAND PASS FILTERS ───────────────────────────────────────────────────────
  {
    ...
    category: 'band-pass-filters', short_spec: 'GSM 900 Band Pass Filter, 880–960 MHz',
  ...
  },
  {
    ...
    category: 'band-pass-filters', short_spec: 'LTE Band 3 Band Pass Filter, 1710–1880 MHz',
  ...
  },
  {
    ...
    category: 'band-pass-filters', short_spec: 'WiFi 2.4 GHz Band Pass Filter, 2400–2485 MHz',
  ...
  // ── RF CABLE ASSEMBLIES ─────────────────────────────────────────────────────
  {
    id: 'ca-001', name: 'AT-CA-MHF4-SMABH-IP-65-1.13-200', slug: 'at-ca-mhf4-smabh-ip65-113-200',
    category: 'rf-cable-assemblies', short_spec: 'IPEX MHF4 to SMA Bulkhead IP65 Cable Assembly, 1.13mm, 200mm',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'MMCX Right-Angle to TNC Female Bulkhead Cable, RG178, 120mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'N Male to BNC Male Cable Assembly, RG402, 2000mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'BNC Male to SMA Male Cable Assembly, RG402, 2000mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'SMA Male to UFL Female Coaxial Cable Assembly, 1.13mm, 200mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'SMA Male to SMA Male Cable Assembly, RG402, 2000mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'IPEX MHF to SMA Bulkhead Cable Assembly, 1.13mm, 150mm',
    frequency_range: 'DC–6 GHz',
  ...
  },
  {
    ...
    category: 'rf-cable-assemblies', short_spec: 'MMCX Right-Angle to SMA Straight / UFL to UFL Cable, 1.13mm, 40mm',
    frequency_range: 'DC–6 GHz',
