...
export const sampleProducts = [
  ...
  },
  {
    ...
    category: 'gps-gnss-antennas', short_spec: 'GPS External Active Antenna, SMA, 28 dB LNA, RG174',
    frequency_range: '1575.425 ±3 MHz',
  ...
  // ── VHF / UHF ANTENNAS ──────────────────────────────────────────────────────
  {
    id: 'vhf-001', name: 'AT-ANT-VHF-RPSMA-DR-3.0', slug: 'at-ant-vhf-rpsma-dr-30',
  ...
  // ── DIPLEXERS ───────────────────────────────────────────────────────────────
  {
    ...
    category: 'diplexers', short_spec: 'RF Diplexer, Dual-Band Frequency Combiner, N Female',
